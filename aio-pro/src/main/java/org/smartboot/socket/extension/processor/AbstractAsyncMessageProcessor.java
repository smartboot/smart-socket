 ...
 */
public abstract class AbstractAsyncMessageProcessor<T> implements AsyncSupportMessageProcessor<T>, NetMonitor {
    ...
    @Override
    public final ProcessMode process(AioSession session, T msg) {
        boolean flag = true;
        for (Plugin<T> plugin : plugins) {
     ...
     */
    public abstract ProcessMode process0(AioSession session, T msg);
