...
|  1.4  |  [1.4.9-SNAPSHOT](https://mvnrepository.com/artifact/org.smartboot.socket/aio-core/1.4.9-SNAPSHOT) |  《[smart-socket技术小册](https://smartboot.gitee.io/book/)》 |最新稳定版|
|  1.4  |  1.4.9-SNAPSHOT |  《[smart-socket技术小册](https://smartboot.gitee.io/book/)》 |开发版，仅供学习交流，切勿在生产环境使用|
