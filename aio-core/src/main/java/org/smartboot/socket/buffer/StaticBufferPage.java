...
class StaticBufferPage extends AbstractBufferPage {
    /**
     * 条件锁
     */
     ...
     */
    StaticBufferPage(int size, boolean direct) {
    ...
    public VirtualBuffer allocate(final int size) {
        ...
        return virtualBuffer == null ? new VirtualBuffer(this, allocate0(size, false), 0, 0) : virtualBuffer;
    }
