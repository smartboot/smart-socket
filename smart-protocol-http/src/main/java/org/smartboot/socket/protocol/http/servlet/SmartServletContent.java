 ...
 */
public class SmartServletContent implements ServletContext {
	...
	public ServletContext getContext(String s) {
		StringTokenizer token = new StringTokenizer(s, getContextPath());
		if (!token.hasMoreTokens()) {
			return null;
		}
		ServletContext context = getContext(token.nextToken());
